...
-- don't forget to run "selection: isArrowAtk: = 1;" when selecting all entries in AtkParam_PC to make sure that all your attacks can hit weak points like the head
